...
from nitorch_core.py import make_tuple, ensure_list
from nitorch_core.padding import pad
from nitorch_nn.base import nitorchmodule, Module, Sequential, ModuleList
from nitorch_nn.activations import make_activation_from_name
...
BoundLike = str
InterpolationLike = Union[int, str]
...
class Conv(Module):
    ...
    def __init__(self, 
        ...
        self.stride = ensure_list(stride, dim)
        self.bound = bound
        self.dilation = ensure_list(dilation, dim)
        self.groups = groups
        self.transposed = transposed
...
class GroupedConv(ModuleList):
    ...
    def __init__(self,
        ...
        transposed : bool, default=False:
            Transposed convolution.
        """
        in_channels = ensure_list(in_channels)
        out_channels = ensure_list(out_channels)
